...
import { QuestionSetByCourseComponent } from "./questionsetbycourse/question-set-by-course/question-set-by-course.component";
...
@Component({
    ...
    imports: [NgFor, NgIf, FormsModule, LessonComponent, LessonbycourseComponent, QuestionSetByCourseComponent]
})
export class CourseComponent implements OnInit {
  ...
  redirectToHomePage() {
    ...
    this.isAddLessonMode = false;
    this.isEditLessonMode= false;
  }
  ...
  navigateToQuestionSet(questionSetId:any){
    this.courseService.setQuestionSetByCourseId(questionSetId);
     console.log("navigation course id"+questionSetId);
   }
