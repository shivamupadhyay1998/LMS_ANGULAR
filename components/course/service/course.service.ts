...
import { QuestionSet } from '../../questionSet/model/questionSet.model';
...
export class CourseService {
  ...
  getAllQuestionSetByCourseId(id:any) {
    const courseUrl = `${baseUrl}courses/${id}/courseToQuestionSet`;
    return this.http.get<QuestionSet[]>(courseUrl, this.options);
  ...
  private questionsetByCourseId: string = '';

  setQuestionSetByCourseId(id: string) {
    this.questionsetByCourseId = id;
  }

  getQuestionSetByCourseId(): string {
    return this.questionsetByCourseId;
  }
