...
export class TopicstatusComponent implements OnInit {
  ...
  topicstatus: Topicstatus = {
    ...
    r_lessonToTopicStatus_c_lessonId: 0,
  ...
  redirectToHomePage() {
    ...
    if (this.viewTopicstatus) { 
      this.topicstatusData = '';
  ...
  createTopicstatus() {
    ...
    this.topicstatus.r_lessonToTopicStatus_c_lessonId = this.topicstatus.lesson.id;
    ...
    this.topicstatusService.findTopicstatus(this.topicstatus.id).subscribe({
      next: (data: any) => {
        ...
        if (data.r_lesssonToTopicStatus_c_lessonId) {
          this.topicstatus.r_lessonToTopicStatus_c_lessonId = data.r_lessonToTopicStatus_c_lessonId;
          this.lessonService.findLesson(this.topicstatus.r_lessonToTopicStatus_c_lessonId).subscribe({
            next: (lessonData: any) => {
  ...
  viewDetail(id: number) {
    ...
    this.topicstatusService.findTopicstatus(id).subscribe({
      next: (data: any) => {
        ...
        this.lessonService.findLesson(this.topicstatusData.r_lessonToTopicStatus_c_lessonId).subscribe({
          next: (data: any) => {
    ...
    this.topicstatusService.getAllTopicstatuss().subscribe({
      next: (response: any) => {
        ...
        this.topicstatusData.forEach((topicstatus: Topicstatus) => {
          ...
          if (topicstatus.r_lessonToTopicStatus_c_lessonId != 0) {
            const rLessonCLessonId = topicstatus.r_lessonToTopicStatus_c_lessonId;
