...
import { QuestionSetService } from '../service/question-set.service';
...
import { AssessmentLevelInQuestionSet, AssessmentTypeInQuestionSet, CourseInQuestionSet, QuestionSet } from '../model/questionSet.model';
...
@Component({
  ...
  styleUrl: './question-set.component.scss'
})
export class QuestionSetComponent {
  ...
  refreshQuestionSetList() {
    ...
    this.questionSetService.getAllQuestionSets().subscribe({
      next: (response: any) => {
